    ...
    <div className="bg-card border border-card-border rounded-2xl p-5 shadow-xl space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-bold text-white">Pelacak Ganti Popok</h3>
            <p className="text-xs text-slate-400">Pantau Hidrasi & Pencernaan</p>
          </div>
        </div>

        <span className="text-[11px] font-semibold px-2.5 py-1 rounded-full bg-slate-800 text-slate-300">
          {diaperLogs.length} Ganti Popok Hari Ini
        </span>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2.5">
        ...
        >
          ...
          <span className="text-xs font-extrabold text-teal-300">Pipis (Basah)</span>
        </button>
      ...
      <div className="grid grid-cols-2 gap-2.5 text-xs">
        <div className="bg-slate-950/40 p-2.5 rounded-xl border border-slate-800 flex items-center justify-between">
          ...
          <span className="font-black text-teal-400 text-sm">{pipisCount} Kali</span>
        </div>
        ...
        <div className="bg-slate-950/40 p-2.5 rounded-xl border border-slate-800 flex items-center justify-between">
          ...
          <span className="font-black text-amber-400 text-sm">{pupCount} Kali</span>
        </div>
      </div>
    </div>
  );
